 ...
 */
public class PilotoWS  {

    private static String TAG = "PilotoWS";

    public static ArrayList<Piloto> getAll(Context context, int idTorneo)
    {
        String METHOD_NAME = "getAllPilotoCategoriaWS";
        ...
        try {
            ...
            return jsonToListCategoria(tmp);
    ...
    public static   ArrayList<Piloto> jsonToListCategoria(String json) {

        ArrayList<Piloto> list = null;
        ...
        try {
            ...
            Type lstT = new TypeToken<ArrayList<Piloto>>(){}.getType();
