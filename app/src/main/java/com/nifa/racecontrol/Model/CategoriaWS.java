...
public class CategoriaWS {
    ...
    private static String TAG = "CategoriaWS";

    public static ArrayList<Categoria> getAll(Context context, int idTorneo)
    {
        String METHOD_NAME = "getAllCategoriaWS";
    ...
    public static   ArrayList<Categoria> jsonToListCategoria(String json) {
        ...
        try {
            ...
            Type lstT = new TypeToken<ArrayList<Categoria>>(){}.getType();
